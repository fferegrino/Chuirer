 ...
 * @author Miguel
 */
public class seguirGpo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //creamos entidadGrupo y agregamos el id de user a los miembros del xml de grupo
        DaGrupos daGpos=new DaGrupos(gpo);
        EnGrupo enGpo=daGpos.recuperaGrupo(gpo);
        boolean band=daGpos.actualizaGrupoUsuario(enGpo, iDuser);
        
        //agregamos el id de grupo en el xml miembroDe dentro de la carpeta de usuario
        boolean band2=DaGrupos.agregaGrupoEnCarpetaUsuario(iDuser, gpo);
        
        //si las 2 aktualizaciones se hicieron correctas
        if(band &&band2){
