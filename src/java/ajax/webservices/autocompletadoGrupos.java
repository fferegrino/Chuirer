 ...
 * @author Miguel
 */
public class autocompletadoGrupos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //tecleado en el textbox de grupos
        ...
        for(int i=0;i<allGpos.size();i++){
            //si existe coincidencia con el prefijo y un grupo, se agrega a conincidencias
            gpo=(String)allGpos.get(i);
            if(gpo.startsWith(prefijo)){
                coincidencias.add(gpo);
            }
        }
